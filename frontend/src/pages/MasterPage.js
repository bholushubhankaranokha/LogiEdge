...
export function Master({
  ...
  return (
    <>
      {customer && <CustomerBody customers={customers} setCustomer={setCustomer} />}
      {itemMenu  && <ItemBody items={items} setItems={setItems} />}
      {masterBody && (
        <MasterBody
  ...
  return (
    <div className="body">
      ...
      <div className="body-container">
        <div className="customer" onClick={() => { onMasterBody(false); onCustomer(true); }}>
          <span className="main-heading">Customer</span>
          <span className="heading">Read or Create Customer Data</span>
        </div>
        <div className="customer" onClick={() => { onMasterBody(false); onItem(true); }}>
